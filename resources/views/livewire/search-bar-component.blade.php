<div class="bg-blue-gray p-0 rounded-[2vh] flex items-center relative">
    ...
    <!-- ... -->
    <!-- Champ de recherche -->
    <input type="text" placeholder="Rechercher..." class="bg-transparent border-none focus:outline-none flex-grow ml-2" wire:model="searchQuery" wire:keydown="searchActivities">

    <!-- Afficher les suggestions dans un rectangle blanc -->
    @if (collect($suggestions)->isNotEmpty())
    
        <ul class="absolute bg-white border border-gray-300 rounded mt-2 left-0 right-0 z-10" style="top: 2rem;"> <!-- Ajustez la valeur '2.5rem' en fonction de la hauteur de votre input -->
